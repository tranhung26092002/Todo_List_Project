window.addEventListener('load', () => {
	...
	const inputTime = document.querySelector("#new-time-input");
	...
	form.addEventListener('submit', (e) => {
		...
		const time_input_el = document.createElement('input');
		time_input_el.classList.add('text');
		...
		task_content_el.appendChild(time_input_el);
